...
class CreateAdminTables extends Migration
{
    ...
    public function up()
    {
        $connection = config('database.connection') ?: config('database.default');
        ...
        Schema::connection($connection)->create('admin_operation_log', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('user_id');
            $table->string('path');
    ...
    public function down()
    {
        ...
        Schema::connection($connection)->dropIfExists('admin_operation_log');
        Schema::connection($connection)->dropIfExists('admin_role_menu');
        Schema::connection($connection)->dropIfExists('admin_user_permissions');
